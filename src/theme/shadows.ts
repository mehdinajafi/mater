...
export const shadows: ThemeOptions["shadows"] = [
  ...
  "rgb(145 158 171 / 20%) 0px 7px 8px -4px, rgb(145 158 171 / 14%) 0px 12px 17px 2px, rgb(145 158 171 / 12%) 0px 5px 22px 4px",
  ...
  "rgb(145 158 171 / 20%) 0px 8px 10px -5px, rgb(145 158 171 / 14%) 0px 16px 24px 2px, rgb(145 158 171 / 12%) 0px 6px 30px 5px",
  ...
  "rgb(145 158 171 / 20%) 0px 10px 13px -6px, rgb(145 158 171 / 14%) 0px 20px 31px 3px, rgb(145 158 171 / 12%) 0px 8px 38px 7px",
...
export const customShadows = {
  ...
  dialog: "rgb(145 158 171 / 24%) -40px 40px 80px -8px",
};
